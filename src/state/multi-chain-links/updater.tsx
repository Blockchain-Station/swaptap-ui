...
export default function Updater(): null {
  ...
  // Scenarios:
  // - If the user lands on Swaptap with a chain id already set in the URL, it's because they've followed a multi
  ...
  // - If the user lands on a Swaptap link without a chain id set in the URL, we set it up for him depending on
